...
pipes = pipe_writesharedmem.c pipe_mean.c pipe_inversefouriertransform.c pipe_dummyemotiv.c pipe_alphabandpass.c pipe_fouriertransform.c pipe_print.c pipe_emotiv.c pipe_writefile.c pipe_readfile.c
